(() => {
  ...
  if (document.body.dataset.aula04CleanReady === 'true') return;
  document.body.dataset.aula04CleanReady = 'true';
  document.body.classList.add('aula03-clean', 'aula04-clean');

  const main = document.querySelector('main#conteudo');
  if (!main || main.parentElement?.classList.contains('aula03-page-grid')) return;
